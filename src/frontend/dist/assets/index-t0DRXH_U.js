const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-BVNjpNag.js","assets/AppButton-dE4Uv1dP.js","assets/navigation-4dt471MC.js","assets/Map-B28e-o4S.js","assets/circle-check-BpFMDyNH.js","assets/Contact-euwQMx4_.js"])))=>i.map(i=>d[i]);
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm", children: "Campus Navigation System" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm text-center", children: "EGS Pillay Engineering College — Helping you navigate with confidence" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-primary rounded-lg flex items-center justify-center shadow-sm group-hover:bg-accent transition-colors duration-200", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-primary-foreground" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-lg text-foreground tracking-tight", children: [
              "Campus",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent", children: "Nav" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "nav",
        {
          ...
          children: NAV_LINKS.map(({ to, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              to,
              ...
              className: [
                ...
                isActive(to) ? "text-primary bg-primary/8" : "text-muted-foreground hover:text-foreground hover:bg-muted"
              ].join(" "),
              children: [
                label,
                isActive(to) && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-0.5 bg-primary rounded-full" })
              ]
            },
            to
          ))
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 py-3 flex flex-col gap-1", children: NAV_LINKS.map(({ to, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Link,
          {
            to,
...
const HomePage = reactExports.lazy(() => __vitePreload(() => import("./Home-BVNjpNag.js"), true ? __vite__mapDeps([0,1,2]) : void 0));
const AboutPage = reactExports.lazy(() => __vitePreload(() => import("./About-DjrL7nU0.js"), true ? [] : void 0));
const MapPage = reactExports.lazy(() => __vitePreload(() => import("./Map-B28e-o4S.js"), true ? __vite__mapDeps([3,1,2,4]) : void 0));
const ContactPage = reactExports.lazy(() => __vitePreload(() => import("./Contact-euwQMx4_.js"), true ? __vite__mapDeps([5,1,4]) : void 0));
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-7xl mx-auto w-full px-4 py-12 space-y-6", children: [
...
const mapRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/map",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageLoader, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPage, {}) })
});
